$(function() {
  ...
  'use strict';
  var data = {
    labels: ["11/2021", "12/2021", "01/2022", "02/2022", "03/2022", "04/2022"],
    datasets: [{
      label: '# of Votes',
      data: [1615, 1750, 1700, 1890, 1800, 2002],
      backgroundColor: [
        'rgba(255, 99, 132, 0.2)',
        'rgba(54, 162, 235, 0.2)',
        'rgba(255, 206, 86, 0.2)',
  ...
  var doughnutPieOptions1 = {
    ...
    legend: {
      position: 'right',
      labels: {fontColor:"rgba(215,215,215,0.8)"},
    },
  };

  var doughnutPieData1 = {
    datasets: [{
      data: [39.44, 20.94, 25.65, 13.97],
      backgroundColor: [
        'rgba(255,99,132,1)',
        'rgba(54, 162, 235, 1)',
        'rgba(255, 206, 86, 1)',
  ...
  if ($("#doughnutChart2").length) {
    ...
    var doughnutPieData3 = {
      datasets: [{
        data: [49.34, 10.53, 10.27, 14.38, 15.48],
        backgroundColor: [
          'rgba(255,99,132,1)',
          'rgba(54, 162, 235, 1)',
          'rgba(255, 206, 86, 1)',
